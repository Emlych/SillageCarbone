...
<img src="/documentation/homepage.png" alt="Home page with search bar, little boat and articles on Sillage Carbon Project" width="500"> [Home page]
<img src="/documentation/productpage.png" alt="Product page with informations on a tuna fish can and a search bar" width="500"> [Product page]
<img src="/documentation/backofficepage.png" alt="Backoffice with side navigation bar, filter on users to display, user cards with email, creation date and button to delete the account" width="500"> [Backoffice page]
